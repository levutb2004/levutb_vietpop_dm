...
class VietPopLogger:
    """Logger for vietpop with file and stream output support."""

    def __init__(self, name: str = 'vietpop'):
        ...
        # Initialize handlers
        # Sử dụng UTF-8 cho console handler để ghi được Unicode
        utf8_stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8', errors='replace')
        self.console_handler = logging.StreamHandler(utf8_stdout)
...
logger = VietPopLogger()

def get_logger(log_file: Optional[str] = None,
               output_stream: Optional[TextIO] = None) -> VietPopLogger:
