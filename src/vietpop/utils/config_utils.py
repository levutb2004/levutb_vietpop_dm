# src/vietpop/utils/config_utils.py
...
def create_config_template(output_path: Path,
    ...
    config: Dict[str, Any] = {
        ...
        # Admin grid for mastergrid creation (used if mastergrid is not provided)
        'admin_grid': {                              # <-- thay admin + admin_column
            'shapefile': f"{prefix}admin.shp",
            'column': 'OBJECTID'
        },
    ...
    header_comment = """# vietpop configuration file
#
...
#     file: Log file name (default: vietpop.log, saved in output directory)
